...
describe('Conversation', () => {
  beforeEach(() => {
    useAuth.setState({
      user: { id: 'me', username: 'me', display_name: 'Me', avatar_url: null, email: 'me@example.com', email_verified: true, created_at: '', bio: null, location: null, website: null, last_seen: null, is_private: false, followers_count: 0, following_count: 0, posts_count: 0, is_following: false, follow_state: 'none', can_view_posts: true, is_blocked: false, is_muted: false, is_admin: false, pending_requests: 0 },
      status: 'authed',
    })
